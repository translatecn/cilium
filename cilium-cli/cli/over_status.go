...
func newCmdStatus() *cobra.Command {
	var params = over_status.K8sStatusParameters{}
	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			collector, err := over_status.NewK8sStatusCollector(k8sClient, params)
			if err != nil {
				return err
			}
	...
	cmd.Flags().IntVar(&params.WorkerCount, "worker-count", over_status.DefaultWorkerCount, "The number of workers to use")
