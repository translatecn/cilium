...
replace (
	github.com/cilium/charts v0.0.0-20250815135331-8443b5068217 => ./3rd/charts
	github.com/cilium/deepequal-gen v0.0.0-20241016021505-f57df2fe2e62 => ./3rd/deepequal-gen
	github.com/cilium/dns v1.1.51-0.20240603182237-af788769786a => ./3rd/dns
	github.com/cilium/endpointslice v0.33.3 => ./3rd/endpointslice
	github.com/cilium/endpointslice-controller v0.0.0-20250410163339-ffb33e27879c => ./3rd/endpointslice-controller
	github.com/cilium/hive v0.0.0-20251008073947-21f6f6e081b5 => ./3rd/hive
	github.com/cilium/linters v0.2.0 => ./3rd/linters
	github.com/cilium/lumberjack => ./3rd/lumberjack
	github.com/cilium/proxy v0.0.0-20250623105955-2136f59a4ea1 => ./3rd/proxy
	github.com/cilium/statedb v0.5.0 => ./3rd/statedb
	github.com/cilium/stream v0.0.1 => ./3rd/stream
	github.com/cilium/workerpool v1.3.0 => ./3rd/workerpool
)
